...
<div class="vista">
  ...
  <form>
    <div class="container2">
        <img src="C:\wamp64\www\proyectoint - copia\imagenes\WhatsApp Image 2024-04-09 at 8.11.51 AM (3).jpeg"alt="Texto alternativo">
    </div>
    
    <h1>¡Hola!</h1>
    <h2>Visualizacion de alumnos</h2>
    Ingrese la matricula del alumno:
    <input type="text" id="matricula">
</br>
    Ingrese contraseña del alumno:
    <input type="password" id="contrasenamatricula">
    <br>
